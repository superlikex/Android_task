...
//		}
		if(get_name.length() == 0 ){
			cursor = db.query("Staff",null, null, null,null,null,null);
		}
		else{
			//cursor = db.query("Staff","name=?",new String[]{get_name},  null,null,null,null);
			cursor = db.rawQuery("select * from Staff where name = ? ",new String[] {get_name});
		...
		if(cursor.moveToFirst()){
			do{
				...
				Log.d("test", "id:"+id+"name:"+name+"age:"+age+"sex:"+sex);
